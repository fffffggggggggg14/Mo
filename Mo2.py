...
def file_xl(file_name, data1, data2, data3, data4, data5, rate):
    wb = xl.Workbook()
    ws = wb.active
    ws.title = 'x1'
    ...
    ws.merge_cells('G3:J6')
    ws['G3'].value = 'INVOLCE' ##
    ws['G3'].font = Font(size = 45, color = 'ffffff', bold = True)
    ws['G3'].alignment = Alignment(horizontal='center', vertical='center')

    ws.merge_cells('G8:H8')
    ws['G8'].value = 'Invoice No' ##
    ws['G8'].font = Font(size = 11, color = 'ffffff', bold = True)
    ws['G8'].alignment = Alignment(horizontal='center', vertical='center')

    ws.merge_cells('I8:J8')
    ws["I8"].value = ": " + "#CON-2028-001" ##
    ws['I8'].font = Font(size = 11, color = 'ffffff')
    ws['I8'].alignment = Alignment(horizontal='center', vertical='center')

    ws.merge_cells('G9:H9')
    ws["G9"].value = "Invoice Date" ##
    ws['G9'].font = Font(size = 11, color = 'ffffff', bold = True)
    ws['G9'].alignment = Alignment(horizontal='center', vertical='center')

    ws.merge_cells('I9:J9')
    ws["I9"].value = ": " + "September 21, 2028" ##
    ws['I9'].font = Font(size = 11, color = 'ffffff')
    ...
    ws["B7"].value = "X CONSTRUCTION" ##
    ws['B7'].font = Font(size = 15, color = 'ffffff', bold = True)
...
file_xl('Mo', data1, data2, data3, data4, data5, 9)